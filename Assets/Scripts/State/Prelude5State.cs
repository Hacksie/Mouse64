...
{
    public class Prelude5State : IState
    {
        ...
        public Prelude5State(PlayerController player, EntityPool entityPool, LevelRenderer levelRenderer, UI.DialogPresenter dialogPresenter)
        {
            this.player = player;
        ...
        public void Begin()
        {
            ...
            this.levelRenderer.LoadPrelude5Level();
        ...
        {
            Logger.Log("Prelude5State", "End dialog");
            this.dialogPresenter.Hide();
